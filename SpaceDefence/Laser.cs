...
namespace SpaceDefence
{
    internal class Laser : GameObject
    {
        ...
        public Laser(LinePieceCollider linePiece, float length)
            : this(linePiece)
        {
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            Rectangle target = new Rectangle(
                (int)linePiece.Start.X,
                (int)linePiece.Start.Y,
                sprite.Width,
                (int)linePiece.Length
            );
            spriteBatch.Draw(
                sprite,
                target,
                ...
                Color.White,
                linePiece.GetAngle(),
                new Vector2(sprite.Width / 2f, sprite.Height),
                SpriteEffects.None,
                1
            );
